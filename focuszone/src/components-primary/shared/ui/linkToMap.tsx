...
import {LinkToMapProps} from "@/components-primary/shared/ui/interface/interface.ts";

const LinkToMap = ({theme, content}: LinkToMapProps) => {
    return (
        <a
        ...
        >
            ...
            <span
                ...
                className={`${theme == 'dark' ? "text-zinc-900" : "text-white "}text-zinc-900 text-[16px]`}
            >
                {content}
            </span>
        </a>
